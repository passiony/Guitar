...
public class GuitarGameplay : MonoBehaviour
{
	...
	{
		GameObject.Find( "GUI Score" ).GetComponent<Text>().enabled = show;
		GameObject.Find( "GUI Multiplier" ).GetComponent<Text>().enabled = show;
	}
	...
	protected void StopCountdown()
	{
		...
		GameObject.Find( "GUI Text" ).GetComponent<Text>().text = "";
	}
	...
	{
		GameObject.Find( "GUI Score" ).GetComponent<Text>().text = Mathf.Floor( Score ).ToString();
	}
	...
	protected void UpdateGuiMultiplier()
	{
		...
		GameObject.Find( "GUI Multiplier" ).GetComponent<Text>().text = "x" + Mathf.Floor( Multiplier ).ToString();
	}
	...
	{
		GameObject.Find( "GUI Score" ).GetComponent<Text>().enabled = false;
		GameObject.Find( "GUI Multiplier" ).GetComponent<Text>().enabled = false;
	...
	protected IEnumerator DisplayText( string text, float duration, float fade = 0f )
	{
		...
		GameObject TextObject = GameObject.Find( "GUI Text" );

		TextObject.GetComponent<Text>().text = text;

		//Make text visible
		Color newColor = TextObject.GetComponent<Text>().material.color;
		newColor.a = 1;
		TextObject.GetComponent<Text>().material.color = newColor;
		...
		while( fadeTime > 0 && TextObject.GetComponent<Text>().text == text )
		{
			newColor = TextObject.GetComponent<Text>().material.color;
		...
		if( TextObject.GetComponent<Text>().text == text )
		{
